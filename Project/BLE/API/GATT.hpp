...
public:
	...
	struct AttributeModifiedEvent
	{
		struct Response
		{
			...
			ushort offset;
			ushort length;
			byte data[BLE_EVT_MAX_PARAM_LEN - 2 - 8];	
		} __attribute__((packed));
	};
...
private:
	...
	{
		Initialize					= 0xFD01,
		UpdateCharacteristicValue	= 0xFD06,
		AddServise					= 0xFD02,
		AddCharacteristic			= 0xFD04,
		AllowRead					= 0xFD27
	};
	struct Response
	{
	...
	struct UpdateCharValue
	{
		ushort service;
		ushort characteristic;
		byte offset;
		byte length;
		byte value[(BLE_CMD_MAX_PARAM_LEN - 6) / sizeof(byte)];
	} __attribute__((packed));
	  ...
	  The attributes for characteristics and descriptors are allocated from the attribute pool.
	    ...
	    * @param[out] Service_Handle Handle of the Service.
	    ...
	    Server also allocates a range of handles for this service from serviceHandle to <serviceHandle + max_attr_records - 1>
	      * @retval Value indicating success or error code.
	      */
	static HCI::Status addService(UUID &uuid, ServiceType sType, byte maxAttributeRecords, ushort &sHandle);
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_include_service(ushort Service_Handle, ushort Include_Start_Handle, ushort Include_End_Handle, byte Include_UUID_Type, Include_UUID_t *Include_UUID, ushort *Include_Handle);
	  ...
	  a variable length.
	    ...
	    * @param[out] Char_Handle Handle of the Characteristic that has been added. 
	    ...
	    has CHAR_PROP_NOTIFY or CHAR_PROP_INDICATE properties.
	      * @retval Value indicating success or error code.
	      */
	static HCI::Status addCharacteristic(ushort sHandle, UUID uuid, ushort length, ushort &cHandle, byte properties, byte permissions, byte evtMask, byte keySize, bool variable = false);
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_add_char_desc(	ushort Service_Handle, ushort Char_Handle, byte Char_Desc_Uuid_Type, Char_Desc_Uuid_t *Char_Desc_Uuid,
//											byte Char_Desc_Value_Max_Len, byte Char_Desc_Value_Length, byte Char_Desc_Value[], byte Security_Permissions,
//											byte Access_Permissions, byte GATT_Evt_Mask, byte Enc_Key_Size, byte Is_Variable, ushort *Char_Desc_Handle);
	  ...
	  it has to retry again till the function returns BLE_STATUS_SUCCESS or any other error code.
	    ...
	    * @param Val_Offset The offset from which the attribute value has to be updated. 
	    ...
	    specified for the attribute while adding the characteristic.
	      ...
	      * @retval Value indicating success or error code.
	      */
	static HCI::Status updateCharValue(ushort service, ushort characteristic, byte offset, byte length, byte value[]);
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_del_char(ushort Serv_Handle, ushort Char_Handle);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_del_service(ushort Serv_Handle);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_del_include_service(ushort Serv_Handle, ushort Include_Handle);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_set_event_mask(uint32_t GATT_Evt_Mask);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_exchange_config(ushort Connection_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_att_find_info_req(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_att_find_by_type_value_req(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle, ushort UUID, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_att_read_by_type_req(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle, byte UUID_Type, UUID_t *UUID);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_att_read_by_group_type_req(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle, byte UUID_Type, UUID_t *UUID);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_att_prepare_write_req(ushort Connection_Handle, ushort Attr_Handle, ushort Val_Offset, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_att_execute_write_req(ushort Connection_Handle, byte Execute);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_disc_all_primary_services(ushort Connection_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_disc_primary_service_by_uuid(ushort Connection_Handle, byte UUID_Type, UUID_t *UUID);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_find_included_services(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_disc_all_char_of_service(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_disc_char_by_uuid(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle, byte UUID_Type, UUID_t *UUID);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_disc_all_char_desc(ushort Connection_Handle, ushort Char_Handle, ushort End_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_read_char_value(ushort Connection_Handle, ushort Attr_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_read_using_char_uuid(ushort Connection_Handle, ushort Start_Handle, ushort End_Handle, byte UUID_Type, UUID_t *UUID);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_read_long_char_value(ushort Connection_Handle, ushort Attr_Handle, ushort Val_Offset);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_read_multiple_char_value(ushort Connection_Handle, byte Number_of_Handles, Handle_Entry_t Handle_Entry[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_write_char_value(ushort Connection_Handle, ushort Attr_Handle, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_write_long_char_value(ushort Connection_Handle, ushort Attr_Handle, ushort Val_Offset, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_write_char_reliable(ushort Connection_Handle, ushort Attr_Handle, ushort Val_Offset, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_write_long_char_desc(ushort Connection_Handle, ushort Attr_Handle, ushort Val_Offset, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
//	  * @brief Start the procedure to read a long characteristic value.
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_read_long_char_desc(ushort Connection_Handle, ushort Attr_Handle, ushort Val_Offset);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_write_char_desc(ushort Connection_Handle, ushort Attr_Handle, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_read_char_desc(ushort Connection_Handle, ushort Attr_Handle);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_write_without_resp(ushort Connection_Handle, ushort Attr_Handle, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_signed_write_without_resp(ushort Connection_Handle, ushort Attr_Handle, byte Attribute_Val_Length, byte Attribute_Val[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_confirm_indication(ushort Connection_Handle);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_write_resp(ushort Connection_Handle, ushort Attr_Handle, byte Write_status, byte Error_Code, byte Attribute_Val_Length, byte Attribute_Val[]);
	...
	/**
	  * @brief Allow the GATT server to send a response to a read request from a client.
	  ...
	  Otherwise the GATT procedure will be timeout.
	    ...
	    * @retval Value indicating success or error code.
	    */
	static HCI::Status allowRead(ushort handle);
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_set_security_permission(ushort Serv_Handle, ushort Attr_Handle, byte Security_Permissions);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_set_desc_value(ushort Serv_Handle, ushort Char_Handle, ushort Char_Desc_Handle, ushort Val_Offset, byte Char_Desc_Value_Length, byte Char_Desc_Value[]);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_read_handle_value(ushort Attr_Handle, ushort Offset, ushort Value_Length_Requested, ushort *Length, ushort *Value_Length, byte Value[]);
//
//	/**
...
//	                                                                  * @retval Value indicating success or error code.
//	                                                                  */
//	static HCI::Status aci_gatt_update_char_value_ext(ushort Conn_Handle_To_Notify, ushort Service_Handle, ushort Char_Handle, byte Update_Type, ushort Char_Length, ushort Value_Offset, byte Value_Length, byte Value[]);
//
//	/**
...
//	    * @retval Value indicating success or error code.
//	    */
//	static HCI::Status aci_gatt_deny_read(ushort Connection_Handle, byte Error_Code);
//
//	/**
...
//	  * @retval Value indicating success or error code.
//	  */
//	static HCI::Status aci_gatt_set_access_permission(ushort Serv_Handle, ushort Attr_Handle, byte Access_Permissions);
};