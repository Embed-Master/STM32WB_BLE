...
//}
//
//HCI::Status LE::hci_set_event_mask(uint8_t Event_Mask[8])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
HCI::Status LE::reset()
{
	...
	HCI::send((ushort)Opcode::Reset, &rq);
	return status;
}

//HCI::Status LE::hci_read_transmit_power_level(uint16_t Connection_Handle,
//	uint8_t Type,
...
//}
//
//HCI::Status LE::hci_set_controller_to_host_flow_control(uint8_t Flow_Control_Enable)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_host_buffer_size(uint16_t Host_ACL_Data_Packet_Length,
...
//}
//
//HCI::Status LE::hci_host_number_of_completed_packets(uint8_t Number_Of_Handles,
...
//}
//
//HCI::Status LE::hci_read_local_version_information(uint8_t *HCI_Version,
...
//}
//
//HCI::Status LE::hci_read_bd_addr(uint8_t BD_ADDR[6])
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_read_buffer_size(uint16_t *HC_LE_ACL_Data_Packet_Length,
...
//}
//
//HCI::Status LE::hci_le_read_local_supported_features(uint8_t LE_Features[8])
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_set_random_address(uint8_t Random_Address[6])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_set_advertising_parameters(uint16_t Advertising_Interval_Min,
...
//}
//
//HCI::Status LE::hci_le_read_advertising_channel_tx_power(uint8_t *Transmit_Power_Level)
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_set_advertising_data(uint8_t Advertising_Data_Length,
...
//}
//
//HCI::Status LE::hci_le_set_scan_response_data(uint8_t Scan_Response_Data_Length,
...
//}
//
//HCI::Status LE::hci_le_set_advertise_enable(uint8_t Advertising_Enable)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_set_scan_parameters(uint8_t LE_Scan_Type,
...
//}
//
//HCI::Status LE::hci_le_set_scan_enable(uint8_t LE_Scan_Enable,
...
//}
//
//HCI::Status LE::hci_le_create_connection(uint16_t LE_Scan_Interval,
//	uint16_t LE_Scan_Window,
...
//}
//
//HCI::Status LE::hci_le_create_connection_cancel(void)
//{
//	struct hci_request rq;
//	HCI::Status LE::status = 0;
//	Osal_MemSet(&rq, 0, sizeof(rq));
...
//}
//
//HCI::Status LE::hci_le_read_white_list_size(uint8_t *White_List_Size)
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_clear_white_list(void)
//{
//	struct hci_request rq;
//	HCI::Status LE::status = 0;
//	Osal_MemSet(&rq, 0, sizeof(rq));
...
//}
//
//HCI::Status LE::hci_le_add_device_to_white_list(uint8_t Address_Type,
//	uint8_t Address[6])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_remove_device_from_white_list(uint8_t Address_Type,
//	uint8_t Address[6])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_connection_update(uint16_t Connection_Handle,
//	uint16_t Conn_Interval_Min,
//	uint16_t Conn_Interval_Max,
//	uint16_t Conn_Latency,
//	uint16_t Supervision_Timeout,
...
//}
//
//HCI::Status LE::hci_le_set_host_channel_classification(uint8_t LE_Channel_Map[5])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_read_channel_map(uint16_t Connection_Handle,
...
//}
//
//HCI::Status LE::hci_le_read_remote_features(uint16_t Connection_Handle)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_encrypt(uint8_t Key[16],
...
//}
//
//HCI::Status LE::hci_le_rand(uint8_t Random_Number[8])
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_start_encryption(uint16_t Connection_Handle,
...
//}
//
//HCI::Status LE::hci_le_long_term_key_request_reply(uint16_t Connection_Handle,
//	uint8_t Long_Term_Key[16])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_long_term_key_requested_negative_reply(uint16_t Connection_Handle)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_read_supported_states(uint8_t LE_States[8])
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_receiver_test(uint8_t RX_Frequency)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_transmitter_test(uint8_t TX_Frequency,
...
//}
//
//HCI::Status LE::hci_le_test_end(uint16_t *Number_Of_Packets)
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_set_data_length(uint16_t Connection_Handle,
//	uint16_t TxOctets,
//	uint16_t TxTime)
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_read_suggested_default_data_length(uint16_t *SuggestedMaxTxOctets,
...
//}
//
//HCI::Status LE::hci_le_write_suggested_default_data_length(uint16_t SuggestedMaxTxOctets,
//	uint16_t SuggestedMaxTxTime)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_read_local_p256_public_key(void)
//{
//	struct hci_request rq;
//	HCI::Status LE::status = 0;
//	Osal_MemSet(&rq, 0, sizeof(rq));
...
//}
//
//HCI::Status LE::hci_le_generate_dhkey(uint8_t Remote_P256_Public_Key[64])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_add_device_to_resolving_list(uint8_t Peer_Identity_Address_Type,
...
//}
//
//HCI::Status LE::hci_le_remove_device_from_resolving_list(uint8_t Peer_Identity_Address_Type,
//	uint8_t Peer_Identity_Address[6])
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_clear_resolving_list(void)
//{
//	struct hci_request rq;
//	HCI::Status LE::status = 0;
//	Osal_MemSet(&rq, 0, sizeof(rq));
...
//}
//
//HCI::Status LE::hci_le_read_resolving_list_size(uint8_t *Resolving_List_Size)
//{
//	struct hci_request rq;
...
//}
//
//HCI::Status LE::hci_le_read_peer_resolvable_address(uint8_t Peer_Identity_Address_Type,
//	uint8_t Peer_Identity_Address[6],
...
//}
//
//HCI::Status LE::hci_le_read_local_resolvable_address(uint8_t Peer_Identity_Address_Type,
//	uint8_t Peer_Identity_Address[6],
...
//}
//
//HCI::Status LE::hci_le_set_address_resolution_enable(uint8_t Address_Resolution_Enable)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_set_resolvable_private_address_timeout(uint16_t RPA_Timeout)
//{
//	struct hci_request rq;
//	uint8_t cmd_buffer[BLE_CMD_MAX_PARAM_LEN];
...
//}
//
//HCI::Status LE::hci_le_read_maximum_data_length(uint16_t *supportedMaxTxOctets,
...
HCI::Status LE::readPhy(ushort handle, byte *txPhy, byte *rxPhy)
{
	ReadPhy::Com0 cmd0;
	cmd0.handle = handle;
	ReadPhy::Response rsp = {};
	HCI::Request rq = { &rsp, sizeof(rsp) };
	HCI::send((ushort)Opcode::ReadPhy, &rq, 2, (byte *)&cmd0);
...
HCI::Status LE::setDefaultPhy(byte all, byte tx, byte rx)
{
	SetDefaultPhy cmd;
	cmd.all = all;
	cmd.tx = tx;
	...
	HCI::Status status = HCI::Status::Success;
	HCI::Request rq = { &status, 1 };
	HCI::send((ushort)Opcode::SetDefaultPhy, &rq, sizeof(cmd), (byte *)&cmd);
	return status;
}

//HCI::Status LE::hci_le_set_phy(uint16_t Connection_Handle,
//	uint8_t ALL_PHYS,
//	uint8_t TX_PHYS,
//	uint8_t RX_PHYS,
...
//}
//
//HCI::Status LE::hci_le_enhanced_receiver_test(uint8_t RX_Frequency,
//	uint8_t PHY,
...
//}
//
//HCI::Status LE::hci_le_enhanced_transmitter_test(uint8_t TX_Frequency,
//	uint8_t Length_Of_Test_Data,
//	uint8_t Packet_Payload,
//	uint8_t PHY)
//{
